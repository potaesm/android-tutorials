package com.suthinan.fcmnotificationsdagger.view;
...
import com.suthinan.fcmnotificationsdagger.service.DaggerServiceComponent;
import com.suthinan.fcmnotificationsdagger.service.ServiceComponent;
import com.suthinan.fcmnotificationsdagger.service.MyFirebaseMessagingService;
import com.suthinan.fcmnotificationsdagger.service.UserService;
...
public class MainActivity extends AppCompatActivity {
    ...
    @Inject MyFirebaseMessagingService myFirebaseMessagingService;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ServiceComponent serviceComponent = DaggerServiceComponent
                .builder()
                .context(this)
                .retrofitBaseUrl(getString(R.string.default_base_url))
                .build();
