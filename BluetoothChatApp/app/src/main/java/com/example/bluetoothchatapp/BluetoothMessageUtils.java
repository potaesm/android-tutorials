...
public class BluetoothMessageUtils {
    ...
    public BluetoothMessageUtils(Handler handler) {
    ...
    private class AcceptThread extends Thread {
        ...
        public AcceptThread() {
            ...
            try {
                tempBluetoothServerSocket = BluetoothAdapter.getDefaultAdapter().listenUsingRfcommWithServiceRecord(APP_NAME, APP_UUID);
            } catch (IOException e) {
    ...
    private class ConnectThread extends Thread {
        ...
        public ConnectThread(BluetoothDevice device) {
            ...
            try {
                tempBluetoothSocket = this.device.createInsecureRfcommSocketToServiceRecord(APP_UUID);
            } catch (IOException e) {
                Log.e("Connect->Constructor", e.toString());
            }
            this.socket = tempBluetoothSocket;
        }
        ...
        public void run() {
            ...
            synchronized (BluetoothMessageUtils.this) {
                connectThread = null;
            }
    ...
    private void connectionLost() {
        ...
        BluetoothMessageUtils.this.start();
    }
