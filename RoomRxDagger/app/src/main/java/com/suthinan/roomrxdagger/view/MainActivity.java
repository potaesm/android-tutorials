package com.suthinan.roomrxdagger.view;
...
import com.suthinan.roomrxdagger.R;
import com.suthinan.roomrxdagger.adapter.UsersAdapter;
import com.suthinan.roomrxdagger.db.DaggerDatabaseComponent;
import com.suthinan.roomrxdagger.db.DatabaseComponent;
import com.suthinan.roomrxdagger.db.UserDatabase;
...
public class MainActivity extends AppCompatActivity {
    ...
    @Inject UserDatabase userDatabase;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseComponent databaseComponent = DaggerDatabaseComponent
                .builder()
                .context(this)
                .dbName(getString(R.string.app_name))
                .build();
